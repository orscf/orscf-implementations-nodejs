...
export class ResearchStudyDefiClient {
   ...
   */
  public getResearchStudyDefinitions(page: number = 0, pageSize: number = 0): Promise<Models.ResearchStudyDefinition[]> {
   ...
   */
  public searchResearchStudyDefinitions(filterExpression: string, sortingExpression: string, page: number = 0, pageSize: number = 0): Promise<Models.ResearchStudyDefinition[]> {
