...
export class SdrEventSubscriptionClient {
   ...
   */
  public subscribeForChangedSubjects(subscriberUrl: string, filter: Models.SubjectFilter): Promise<string> {
...
export class SubjectConsumeClient {
   ...
   */
  public searchSubjects(sortingField: string, sortDescending: boolean = false, filter: Models.SubjectFilter, includeArchivedRecords: boolean = false, limitResults: number = 0): Promise<{result: Models.SubjectMetaRecord[]}> {
   ...
   */
  public searchChangedSubjects(minTimestampUtc: number, filter: Models.SubjectFilter): Promise<{latestTimestampUtc: number, createdRecords: Models.SubjectMetaRecord[], modifiedRecords: Models.SubjectMetaRecord[], archivedRecords: Models.SubjectMetaRecord[]}> {
