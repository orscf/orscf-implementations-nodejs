...
export class VdrEventSubscriptionClient {
   ...
   */
  public subscribeForChangedVisits(subscriberUrl: string, filter: Models.VisitFilter = null): Promise<string> {
...
export class VisitConsumeClient {
   ...
   */
  public searchVisits(sortingField: string = null, sortDescending: boolean = false, filter: Models.VisitFilter = null, includeArchivedRecords: boolean = false, limitResults: number = 0): Promise<{result: Models.VisitMetaRecord[]}> {
   ...
   */
  public searchChangedVisits(minTimestampUtc: number, filter: Models.VisitFilter = null): Promise<{latestTimestampUtc: number, createdRecords: Models.VisitMetaRecord[], modifiedRecords: Models.VisitMetaRecord[], archivedRecords: Models.VisitMetaRecord[]}> {
