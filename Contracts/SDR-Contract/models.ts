/* based on ORSCF SubjectData Contract v0.1.0.10914 */

/* ERROR: Cannot find XML-Doc file 'D:\a\r1\a\orscf-implementations-dotnet\(Stage)\Bin\ORSCF.SubjectData.Contract.xml'
