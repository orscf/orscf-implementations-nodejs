...
export interface ISdrEventSubscriptionService {
   ...
   */
  SubscribeForChangedSubjects(subscriberUrl : string, filter : Models.SubjectFilter) : string;
   ...
   */
  NoticeChangedSubjects(eventUid : string, eventSignature : string, subscriptionUid : string, publisherUrl : string, createdRecords : Models.SubjectMetaRecord[], modifiedRecords : Models.SubjectMetaRecord[], archivedRecords : Models.SubjectMetaRecord[], terminateSubscription : (out: boolean) => void) : void;
...
export interface ISubjectConsumeService {
   ...
   */
  SearchSubjects(result : (out: Models.SubjectMetaRecord[]) => void, sortingField : string, sortDescending : boolean, filter : Models.SubjectFilter, includeArchivedRecords : boolean, limitResults : number) : void;
   ...
   * @param filter values by field name (can also be a 'CustomField') which will used as AND-linked filter
   */
  SearchChangedSubjects(minTimestampUtc : number, latestTimestampUtc : (out: number) => void, createdRecords : (out: Models.SubjectMetaRecord[]) => void, modifiedRecords : (out: Models.SubjectMetaRecord[]) => void, archivedRecords : (out: Models.SubjectMetaRecord[]) => void, filter : Models.SubjectFilter) : void;
   ...
   */
  GetCustomFieldDescriptorsForSubject(languagePref : string) : Models.CustomFieldDescriptor[];
   ...
   */
  CheckSubjectExisitence(subjectUids : string[], unavailableSubjectUids : (out: string[]) => void, availableSubjectUids : (out: string[]) => void) : void;
   ...
   * @param result
   */
  GetSubjectFields(subjectUids : string[], unavailableSubjectUids : (out: string[]) => void, result : (out: Models.SubjectFields[]) => void) : void;
   ...
   * @param result
   */
  ExportSubjects(subjectUids : string[], unavailableSubjectUids : (out: string[]) => void, result : (out: Models.SubjectStructure[]) => void) : void;
...
export interface ISubjectHL7ExportService {
   ...
   */
  ExportSubjectFhirRessources(subjectUid : string, subjectFhirRessources : (out: Models.SubjectFhirRessourceContainer[]) => void) : boolean;
...
export interface ISubjectHL7ImportService {
   ...
   */
  ImportSubjectFhirRessources(subjectFhirRessources : Models.SubjectFhirRessourceContainer[], createdSubjectUids : (out: string[]) => void, updatedSubjectUids : (out: string[]) => void) : void;
...
export interface ISubjectSubmissionService {
   ...
   */
  ArchiveSubjects(subjectUids : string[], archivedSubjectUids : (out: string[]) => void) : void;
   ...
   */
  UnarchiveSubjects(subjectUids : string[], unarchivedSubjectUids : (out: string[]) => void) : void;
   ...
   * @param updatedSubjectUids
   */
  ApplySubjectMutations(mutationsBySubjecttUid : Object, updatedSubjectUids : (out: string[]) => void) : void;
   ...
   * @param updatedSubjectUids
   */
  ApplySubjectBatchMutation(subjectUids : string[], mutation : Models.BatchableSubjectMutation, updatedSubjectUids : (out: string[]) => void) : void;
   ...
   * @param updatedSubjectUids
   */
  ImportSubjects(subjects : Models.SubjectStructure[], createdSubjectUids : (out: string[]) => void, updatedSubjectUids : (out: string[]) => void) : void;
